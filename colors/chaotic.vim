...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi IncSearch term=reverse cterm=bold ctermbg=230 ctermfg=232 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=237 ctermfg=232 gui=reverse guibg=bg guifg=fg
